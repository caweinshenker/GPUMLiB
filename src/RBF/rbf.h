...
void rbf(Eigen::MatrixXd Input, Eigen::MatrixXd Target, int network_size, int number_neighbours, Eigen::MatrixXd &OutWeights, Eigen::MatrixXd &OutCenters){
	...
	while (changed){
		...
		KernelEuclidianDistance(device_output2.Pointer(), (int)device_output2.Rows(), (int)device_output2.Columns(), device_X.Pointer(), (int)device_X.Columns(), device_Centers.Pointer(), (int)device_Centers.Columns());
		...
		KernelCenterAttribution(device_output2.Pointer(), (int)device_output2.Rows(), (int)device_output2.Columns(), device_attrib_center);
