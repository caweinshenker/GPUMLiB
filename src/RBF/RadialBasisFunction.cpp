...
namespace GPUMLib {
	...
	HostMatrix<float> RadialBasisFunction::Test(HostMatrix<float> &Input) {
		...
		KernelActivationMatrix(device_activ_matrix.Pointer(), dev_input.Pointer(), dCenters.Pointer(), (int)dev_input.Columns(), (int)dCenters.Columns(), (int)device_activ_matrix.Columns(), (int)device_activ_matrix.Rows(), scaling_factor, device_c_width.Pointer());
	...
	DeviceMatrix<float> RadialBasisFunction::Test(DeviceMatrix<float> &Input) {
		...
		KernelActivationMatrix(device_activ_matrix.Pointer(), Input.Pointer(), dCenters.Pointer(), (int)Input.Columns(), (int)dCenters.Columns(), (int)device_activ_matrix.Columns(), (int)device_activ_matrix.Rows(), scaling_factor, device_c_width.Pointer());
	...
	DeviceMatrix<float> RadialBasisFunction::Test(DeviceMatrix<float> &Input, DeviceMatrix<float> &Centers, DeviceMatrix<float> &Weights, DeviceArray<float> &Widths) {
		...
		KernelActivationMatrix(device_activ_matrix.Pointer(), Input.Pointer(), Centers.Pointer(), (int)Input.Columns(), (int)Centers.Columns(), (int)device_activ_matrix.Columns(), (int)device_activ_matrix.Rows(), scaling_factor, Widths.Pointer());
	...
	void RadialBasisFunction::Train(HostMatrix<float> &Input, HostMatrix<float> &Target) {
		...
		KernelActivationMatrix(device_activ_matrix.Pointer(), device_X.Pointer(), dCenters.Pointer(), (int)device_X.Columns(), (int)dCenters.Columns(), (int)device_activ_matrix.Columns(), (int)device_activ_matrix.Rows(), scaling_factor, device_c_width.Pointer());
	...
	void RadialBasisFunction::AdjustWidths(int rneighbours) {
		...
		KernelCalculateDistance(device_output2.Pointer(), dCenters.Pointer(), dCenters.Pointer(), (int)dCenters.Columns(), (int)dCenters.Columns(), (int)device_output2.Columns(), (int)device_output2.Rows());
		cudaMemset(device_c_width.Pointer(), 0, sizeof(float)*device_c_width.Length());
		KernelAdjustWidths(device_output2.Pointer(), (int)device_output2.Rows(), (int)device_output2.Columns(), rneighbours, device_c_width.Pointer());
	}
