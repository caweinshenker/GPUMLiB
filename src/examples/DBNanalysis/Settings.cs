...
namespace DBNanalysis {
	...
	class Settings {
		...
		[CategoryAttribute("Images"), DescriptionAttribute("First image visible."), DefaultValue(1)]
		public int Position { get; set; }

		[CategoryAttribute("Images"), DescriptionAttribute("Zoom"), DefaultValue(2)]
		public int Zoom {
			get { return zoom; }
		...
		[CategoryAttribute("Reconstruction"), DescriptionAttribute("Binarize reconstruction"), DefaultValue(false)]
		public bool Binarize { get; set; }

		[CategoryAttribute("Save images"), DescriptionAttribute("Number of images to save"), DefaultValue(10), DisplayName("Number of images to save")]
		public int NumberImagesWrite { get; set; }
