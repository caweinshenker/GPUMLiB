...
int main(int argc, char* argv[]) {
	...
	if (!device.SupportsCuda()) {
		std::cout << "Device does not support cuda" << endl;
		return 0;
	}
	...
	std::cout << "Random Generator.........: " << randomGenerator << endl;
	...
	// train the network
	std::cout << endl << "This is a simple example that demonstrates how to use the Multiple Back-Propagation algorithm." << endl;
	std::cout << "Use ATS (Autonomous Training System) if you want to train other networks." << endl;
	...
	std::cout << "Epochs: " << mbp.GetEpoch() << endl;
	std::cout << "RMS: " << mbp.GetRMS();
	...
	std::cout << endl << "A network was saved (" << sstream.str() << "). Use the Multiple Back-Propagation Software, available at http://dit.ipg.pt/MBP, to read it and verify the training results.";
