...
#define SVW(_R, _C) svw[(_R)][(_C)]
	...
	__global__ void cuda_nmf_additive_divergence_update_matrix_w(cudafloat * W, cudafloat * H, cudafloat * V, cudafloat * WH, cudafloat * sumH, int n, int m, int r) {
	...
	__global__ void cuda_nmf_additive_divergence_update_matrix_h(cudafloat * H, cudafloat * W, cudafloat * V, cudafloat * WH, cudafloat * sumW, int n, int m, int r) {
...
extern "C" cudaError_t gpumlib_cuda_nmf_additive_divergence_update_matrix_w(dim3 gridDim, dim3 blockDim, cudafloat * W, cudafloat * H, cudafloat * V, cudafloat * WH, cudafloat * sumH, int n, int m, int r) {
	GPUMLib::cuda_nmf_additive_divergence_update_matrix_w<<<gridDim, blockDim>>>(W, H, V, WH, sumH, n, m, r);
...
extern "C" cudaError_t gpumlib_cuda_nmf_additive_divergence_update_matrix_h(dim3 gridDim, dim3 blockDim, cudafloat * H, cudafloat * W, cudafloat * V, cudafloat * WH, cudafloat * sumW, int n, int m, int r) {
	GPUMLib::cuda_nmf_additive_divergence_update_matrix_h<<<gridDim, blockDim>>>(H, W, V, WH, sumW, n, m, r);
