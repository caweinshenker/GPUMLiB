...
namespace GPUMLib {
	...
	template <int blockSize> __global__ void Max(cudafloat * inputs, cudafloat * output, int numInputs) {
	...
	template <int blockSize> __global__ void MaxIndex(cudafloat * inputs, cudafloat * output, int * indexes, int numInputs) {
		extern __shared__ cudafloat maxvalue[];
	...
	template <int blockSize> __global__ void MaxSmallArray(cudafloat * inputs, cudafloat * output, int numInputs) {
		extern __shared__ cudafloat maxvalue[];
	...
	template <int blockSize> __global__ void MaxSmallArrayIndex(cudafloat * inputs, cudafloat * output, int * maxIndex, int numInputs, int * indexes) {
		extern __shared__ cudafloat maxvalue[];
