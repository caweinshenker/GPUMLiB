...
#ifndef GPUMLIB_MBP_KERNELS_H
#define GPUMLIB_MBP_KERNELS_H
...
//! \param[in] neuronsNextLayer Number of neurons in the next layer.
//! \param[in] neurons Number of neurons.
...
//! CalculateLocalGradient<<<patterns, dimOutputsNeurons, (outputs * (neurons + 1)) * sizeof(cudafloat)>>>(rms, bestRMS, maxErrorGrowthToApplyRobustLearning, outputs, nextLayerWeights, m, nextLayerlocalGradient, numOutputs, numNeurons, localGradient, lgSpaceNet);
//! \endcode
//! \code 
//! dim3 dimOutputsNeurons(numOutputs, numNeurons);
//! CalculateLocalGradient<<<patterns, dimOutputsNeurons, (outputs * (neurons + 1)) * sizeof(cudafloat)>>>(rms, bestRMS, maxErrorGrowthToApplyRobustLearning, outputs, nextLayerWeights, nullptr, nextLayerlocalGradient, numOutputs, numNeurons, localGradient, nullptr);
//! \endcode
//! \sa FireOutputLayer
//! \sa KernelFireOutputLayer
//! \sa RobustLearning
