...
#ifndef GPUMLIB_NMF_MULTIPLICATIVE_EUCLIDEAN_H
#define GPUMLIB_NMF_MULTIPLICATIVE_EUCLIDEAN_H
...
namespace GPUMLib {
	...
	public:
		...
		NMF_MultiplicativeEuclidianDistance(HostMatrix<cudafloat> & v, int r) : NMF(v, r), WtV(r, v.Columns(), ColumnMajor), WtW(r, r, ColumnMajor), WtWH(r, v.Columns(), ColumnMajor), VHt(v.Rows(), r, ColumnMajor), WHHt(v.Rows(), r, ColumnMajor) {
			blocksH = NumberBlocks((int)H.Elements(), SIZE_BLOCKS_NMF);
			blocksW = NumberBlocks((int)W.Elements(), SIZE_BLOCKS_NMF);
		}
...
#endif // GPUMLIB_NMF_MULTIPLICATIVE_EUCLIDEAN_H
