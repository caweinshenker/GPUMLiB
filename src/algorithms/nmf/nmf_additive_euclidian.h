...
#ifndef GPUMLIB_NMF_ADDITIVE_EUCLIDEAN_H
#define GPUMLIB_NMF_ADDITIVE_EUCLIDEAN_H
...
namespace GPUMLib {
	...
	public:
		...
		NMF_AdditiveEuclidian(HostMatrix<cudafloat> & v, int r) : NMF(v, r), deltaH(r, v.Columns()), deltaH2(r, v.Columns()), deltaW(v.Rows(), r), deltaW2(v.Rows(), r), aux(r, r){
		}
		...
		//! \attention Matrix V must be in column-major order
		NMF_AdditiveEuclidian(HostMatrix<cudafloat> & v, HostMatrix<cudafloat> & w, HostMatrix<cudafloat> & h) : NMF(v, w, h), deltaH(h.Rows(), v.Columns()), deltaH2(h.Rows(), v.Columns()), deltaW(v.Rows(), w.Columns()), deltaW2(v.Rows(), w.Columns()), aux(w.Columns(), w.Columns()) {
		}
...
#endif // GPUMLIB_NMF_ADDITIVE_EUCLIDEAN_H
