...
if( DEFINED CSHARP_DOTNET_FOUND )
  ...
  if( NOT DEFINED CSHARP_DOTNET_COMPILER_${CSHARP_DOTNET_VERSION} )
    ...
    set( CSHARP_DOTNET_VERSION "CSHARP_DOTNET_VERSION-NOTVALID" CACHE STRING "C# .NET compiler version, choices: ${CSHARP_DOTNET_VERSIONS}")
...
foreach ( csharp_dotnet_executable ${csharp_dotnet_executables} )
  ...
  if( NOT DEFINED CSHARP_DOTNET_VERSIONS )
	...
	#--------------------------------------------------------------------------------------------------
	# Changed by Noel Lopes (noel@ipg.pt)
	#--------------------------------------------------------------------------------------------------
...
if( CSHARP_DOTNET_FOUND )
  ...
  set( CSHARP_DOTNET_VERSION ${csharp_dotnet_version_temp} CACHE STRING "C# .NET compiler version. Valid values are ${CSHARP_DOTNET_VERSIONS}" )
  set_property(CACHE CSHARP_DOTNET_VERSION PROPERTY STRINGS ${CSHARP_DOTNET_VERSIONS})
  #--------------------------------------------------------------------------------------------------
endif( )
